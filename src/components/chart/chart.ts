    ...
    return historicalService
      ...
      .then(results => {
        ...
        return historicalService
            ...
            .then(results2 => {
                for (const market in results2.initialPrices) {
                    results.initialPrices[market] = results2.initialPrices[market]
                }   
                (results as any).markets  = [...(results as any).markets , ...(results2 as any).markets ]
